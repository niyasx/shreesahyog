class ManualDiAllotmentActionTransportModel {
  ...
  ManualDiAllotmentActionTransportModel(
  ...
  ManualDiAllotmentActionTransportModel.fromJson(Map<String, dynamic> json) {
