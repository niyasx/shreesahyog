class FrieghtBillTypeModel {
  ...
  FrieghtBillTypeModel.fromJson(Map<String, dynamic> json) {
...
class ResponseList {
  int? freightBillId;
  String? freightBillType;

  ResponseList({this.freightBillId, this.freightBillType});

  ResponseList.fromJson(Map<String, dynamic> json) {
    freightBillId = json['freightBillId'];
    freightBillType = json['freightBillType'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['freightBillId'] = freightBillId;
    data['freightBillType'] = freightBillType;
    return data;
  }
}
